...
public class SeriesAdapter extends RecyclerView.Adapter<SeriesAdapter.ViewHolder>{
    ...
    public SeriesAdapter(Context context, List<SeriesModel> movieModels, IMyViewHolderClicks viewHolderClicks){
    ...
    @Override
    public void onBindViewHolder(@NonNull final SeriesAdapter.ViewHolder viewHolder, @SuppressLint("RecyclerView") final int i) {
        final SeriesModel movieModel= movieModels.get(i);
...
//        }
        ...
        viewHolder.ratingBar.setRating(Float.valueOf(movieModel.getRating()));
    }
    ...
    public interface IMyViewHolderClicks {
        void onClick(int i, SeriesModel movieModel);
        void onFocus(int i, SeriesModel movieModel);
    }
    ...
    public void setMovieModels(List<SeriesModel> movieModels){
        this.movieModels=movieModels;
        row_index=-1;
        notifyDataSetChanged();
    }
