...
import com.legacycombo.apps.FirstServer;
import com.legacycombo.apps.MyApp;
import com.legacycombo.dialog.UpdateDlg;
import com.legacycombo.models.AppInfoModel;
import com.legacycombo.models.DataModel;
import com.legacycombo.utils.Utils;
...
//                            url="http://pelungoiptv.qhq.cc:25461/";
                    ...
                    for(int i =0;i<Constants.userDataModel.getImage_urls().size()-2;i++){
                        AppInfoModel appInfoModel = new AppInfoModel();
                        appInfoModel.setImageurl(Constants.userDataModel.getImage_urls().get(i+2));
                        appInfoModels.add(appInfoModel);
                    }
                    MyApp.instance.getPreference().put(Constants.getAppInfoModel(),appInfoModels);
//                            getUpdate();
                    startNextActivity();
